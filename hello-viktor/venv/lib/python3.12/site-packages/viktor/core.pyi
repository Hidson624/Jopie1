...
class _Session(requests.Session):
    ...
    def __init__(self, with_retries: bool, retry_read: bool = True) -> None: ...
...
class _Context:
    ...
    session_with_retries_no_read: requests.Session
    @staticmethod
    def clear() -> None: ...
...
class Storage:
    ...
    **(new in v14.28.0)**: Storage.set() Key length has been increased from 64 to 256 characters.
    ...
    For each of these methods, a scope can be defined to point to a specific section in the storage. These scopes
      ...
      - session **(new in v14.28.0)**  : when data needs to be accessed within an editor session
    ...
    def set(self, key: str, data: File, *, scope: str, entity: Entity = None) -> None:
        ...
        :param key: Unique key on which the data is set (max. 256 characters).
        :param data: Data to be stored.
        :param scope: Applicable scope, 'entity' | 'workspace' | 'session'.
